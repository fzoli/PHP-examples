...
$kep2 =  imagecreatefromjpeg("files/captcha/".$szoveg[0] . ".jpeg");
$kep3 =  imagecreatefromjpeg("files/captcha/".$szoveg[1] . ".jpeg");
$kep4 =  imagecreatefromjpeg("files/captcha/".$szoveg[2] . ".jpeg");
$kep5 =  imagecreatefromjpeg("files/captcha/".$szoveg[3] . ".jpeg");
$kep6 =  imagecreatefromjpeg("files/captcha/".$szoveg[4] . ".jpeg");
