...
$().ready(function() {
	...
	$("#munkaMegnev").autocomplete("film_list_stab.php", {
		selectFirst: false,
		formatItem: formatItem
	});
...
<title>Stábos filmhezadása</title>
</head>
<body>
<?php $page->printPageOpen(); $page->printFilmEditMenu(1,7); ?>
...
if(!empty($_POST)) {
	$film=new Film($filmDbName);
	print ($film->addStab($_POST))?"Személy hozzáadva!":'Hiba! A MySQL mondta: '.mysql_error();
}
?>
</div>
